        ...
        <div className="h-[205px] relative w-[48px]">
          <div className="absolute flex inset-[0_25.68%_0_26.11%] items-center justify-center">
            <div className="-rotate-90 flex-none h-[23.139px] w-[205px]">
              <div className="relative size-full"><div className="absolute inset-[0.88%_0_1.62%_0]"><svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 205 22.5608"><g><path d={hdSvgPaths.p3e626280} fill="white" /><path d={hdSvgPaths.p37094d00} fill="white" /><path d={hdSvgPaths.p2699ee00} fill="white" /><path clipRule="evenodd" d={hdSvgPaths.p3b5f2580} fill="white" fillRule="evenodd" /><path d={hdSvgPaths.p228bd600} fill="white" /><path d={hdSvgPaths.pffcf980} fill="white" /></g></svg></div></div>
            </div>
          </div>
          <div className="absolute flex inset-[31.12%_-0.44%_42.84%_-0.75%] items-center justify-center">
            <div className="flex-none h-[38.523px] rotate-[-72.58deg] skew-x-[-3.13deg] w-[41.763px]">
              <div className="relative size-full"><div className="absolute inset-[-0.65%_0_0_0]"><svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 41.7627 38.7737"><g><g><path d={hdSvgPaths.p1622ab00} fill="white" stroke="white" /><path d={hdSvgPaths.p35fbcd80} fill="white" stroke="white" /><path d={hdSvgPaths.p27967700} fill="white" stroke="white" /><path d={hdSvgPaths.p11134c00} fill="white" stroke="white" /><path d={hdSvgPaths.p107f3f80} fill="white" stroke="white" /></g><ellipse cx="2.58698" cy="2.5515" fill="white" rx="2.58698" ry="2.5515" transform="matrix(0.999959 -0.00905923 -0.0121755 0.999926 18.0789 15.2187)" /></g></svg></div></div>
            </div>
          </div>
        </div>
      </div>
